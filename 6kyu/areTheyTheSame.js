 ...
 * in a squared, regardless of the order. Examples 
 * Valid arrays
...
const comp = (array1, array2) => array1 != null && array2 != null ? array1.sort((a,b)=> a-b).toString() === array2.map(n => n = Math.sqrt(n)).sort((a,b)=> a-b).toString(): false