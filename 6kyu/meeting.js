 ...
 * Could you make a program that makes this string uppercase gives it 
 ...
 * separated by a comma. So the result of function meeting(s) will be:
...
function meeting(s) {
    ...
    s = s.map((_, i) => `(${s[i].split(":").reverse().join(', ')})`)
