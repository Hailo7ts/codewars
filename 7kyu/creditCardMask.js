 ...
 * don't want that shown on your screen. Instead, we mask it. Your task is
 * to write a function maskify, which changes all but the last four 
 * characters into '#'.
 */

// return masked string
const maskify = (cc)=> cc.split('').map((num,i)=> i < cc.length-4 ? num = '#': num).join('')
