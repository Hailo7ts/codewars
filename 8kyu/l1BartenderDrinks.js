 ...
 * outputs according to the following table:Input	Output "Jabroni"
 * "Patron Tequila" "School Counselor" "Anything with Alcohol" 
 * "Programmer"	"Hipster Craft Beer" "Bike Gang Member"	"Moonshine"
 * "Politician"	"Your tax dollars" "Rapper"	"Cristal" anything else	"Beer"
 ...
 * "Beer". Make sure you cover the cases where certain words do not show 
 * up with correct capitalization. For example, the input "pOLitiCIaN" 
