 ...
 * negative:-1,-100 , integer:123,456, decimal:3.1415926,-8.88 etc.. Numbers can use 
 * operators such as + - * / % Task I've written five function equal1,equal2,equal3,equal4,
 * equal5, defines six global variables v1 v2 v3 v4 v5 v6, every function has two local 
 ...
 * refer to this example to complete the following functions. When you have finished the work,
 *  click "Run Tests" to see if your code is working properly. In the end, click "Submit" to 
 * submit your code pass this kata.
 * 
 * P: none
 * R: integer
 * E: assert.strictEqual(equal1(), 100, "value of a+b is not equal to 100");
